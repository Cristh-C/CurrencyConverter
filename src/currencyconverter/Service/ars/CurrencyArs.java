package currencyconverter.Service.ars;

import currencyconverter.Service.Service;

/**
 * Clase que modela la moneda ARS (Peso argentino)
 * */
public class CurrencyArs implements Service{
     ...
     * @param currencyQuantity Cantidad de la moneda
     * */
    public CurrencyArs(double currencyQuantity) {
     ...
     * @param currencyValue Valor de la moneda.
     * */
    public CurrencyArs(double currencyQuantity, double currencyValue) {
        this.currencyQuantity = currencyQuantity;
    ...
    public String printConcurrencyConverter() {
        ...
        result.append(" $" + this.calculateConcurrencyConverter() +" Pesos argentinos. (ARS)\n");
        result.append("\n");
        result.append("----------------------------------\n");
