package currencyconverter.Service.usd;

import currencyconverter.Service.Service;

/**
 * Clase que modela la moneda USD (Dólar estadounidense)
 * */
public class CurrencyUsd implements Service{
     ...
     * @param currencyQuantity Cantidad de la moneda
     * */
    public CurrencyUsd(double currencyQuantity) {
     ...
     * @param currencyValue Valor de la moneda.
     * */
    public CurrencyUsd(double currencyQuantity, double currencyValue) {
        this.currencyQuantity = currencyQuantity;
    ...
    public String printConcurrencyConverter() {
        ...
        result.append(" $" + this.calculateConcurrencyConverter() +" Dólares. (USD)\n");
        result.append("\n");
        result.append("----------------------------------\n");
